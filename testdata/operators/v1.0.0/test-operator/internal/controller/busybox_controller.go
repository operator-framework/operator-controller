...
const busyboxFinalizer = "example.olmv1.com/finalizer"
...
// +kubebuilder:rbac:groups=example.olmv1.com,resources=busyboxes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=example.olmv1.com,resources=busyboxes/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=example.olmv1.com,resources=busyboxes/finalizers,verbs=update
...
func (r *BusyboxReconciler) doFinalizerOperationsForBusybox(cr *examplev1.Busybox) {
...
func (r *BusyboxReconciler) deploymentForBusybox(
	busybox *examplev1.Busybox) (*appsv1.Deployment, error) {
	ls := labelsForBusybox()
