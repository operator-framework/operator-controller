...
import (
	"context"
	"github.com/operator-framework/operator-controller/testdata/images/bundles/test-operator/v1.0.0/internal/controller"
	...
	testolmv1 "github.com/operator-framework/operator-controller/testdata/images/bundles/test-operator/v1.0.0/api/v1"
)
...
func newClientAndReconciler(t *testing.T) (client.Client, *controller.TestOperatorReconciler) {
	...
	require.NoError(t, testolmv1.AddToScheme(sch))
