...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterExtensionReference) DeepCopyInto(out *ClusterExtensionReference) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterExtensionReference.
func (in *ClusterExtensionReference) DeepCopy() *ClusterExtensionReference {
	if in == nil {
		return nil
	}
	out := new(ClusterExtensionReference)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ClusterExtensionRevisionSpec) DeepCopyInto(out *ClusterExtensionRevisionSpec) {
	*out = *in
	out.ClusterExtensionRef = in.ClusterExtensionRef
	out.BundleMetadata = in.BundleMetadata
	in.AvailableSince.DeepCopyInto(&out.AvailableSince)
}
