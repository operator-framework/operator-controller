...
func (in *ClusterExtensionSpec) DeepCopyInto(out *ClusterExtensionSpec) {
	*out = *in
	...
	if in.Template != nil {
		...
		*out = new(ClusterExtensionTemplate)
		(*in).DeepCopyInto(*out)
	}
	if in.Install != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterExtensionTemplate) DeepCopyInto(out *ClusterExtensionTemplate) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterExtensionTemplate.
func (in *ClusterExtensionTemplate) DeepCopy() *ClusterExtensionTemplate {
	if in == nil {
		return nil
	}
	out := new(ClusterExtensionTemplate)
