...
CRDIFY := $(GOBIN)/crdify-v0.4.0
$(CRDIFY): $(BINGO_DIR)/crdify.mod
	@# Install binary/ries using Go 1.14+ build command. This is using bwplotka/bingo-controlled, separate go module with pinned dependencies.
	@echo "(re)installing $(GOBIN)/crdify-v0.4.0"
	@cd $(BINGO_DIR) && GOWORK=off $(GO) build -mod=mod -modfile=crdify.mod -o=$(GOBIN)/crdify-v0.4.0 "sigs.k8s.io/crdify"
