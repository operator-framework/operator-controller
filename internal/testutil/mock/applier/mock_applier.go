...
// Source: github.com/operator-framework/operator-controller/internal/operator-controller/applier (interfaces: Preflight,HelmReleaseToObjectsConverterInterface,HelmChartProvider,ClusterObjectSetGenerator,OrbClusterObjectSetGenerator,ManifestProvider)
//
// Generated by this command:
//
//	mockgen -destination=applier/mock_applier.go -package=applier github.com/operator-framework/operator-controller/internal/operator-controller/applier Preflight,HelmReleaseToObjectsConverterInterface,HelmChartProvider,ClusterObjectSetGenerator,OrbClusterObjectSetGenerator,ManifestProvider
//
...
import (
	...
	v1alpha1 "github.com/joelanford/orb-operator/applyconfigurations/api/v1alpha1"
...
// MockOrbClusterObjectSetGenerator is a mock of OrbClusterObjectSetGenerator interface.
type MockOrbClusterObjectSetGenerator struct {
	ctrl     *gomock.Controller
	recorder *MockOrbClusterObjectSetGeneratorMockRecorder
	isgomock struct{}
}

// MockOrbClusterObjectSetGeneratorMockRecorder is the mock recorder for MockOrbClusterObjectSetGenerator.
type MockOrbClusterObjectSetGeneratorMockRecorder struct {
	mock *MockOrbClusterObjectSetGenerator
}

// NewMockOrbClusterObjectSetGenerator creates a new mock instance.
func NewMockOrbClusterObjectSetGenerator(ctrl *gomock.Controller) *MockOrbClusterObjectSetGenerator {
	mock := &MockOrbClusterObjectSetGenerator{ctrl: ctrl}
	mock.recorder = &MockOrbClusterObjectSetGeneratorMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockOrbClusterObjectSetGenerator) EXPECT() *MockOrbClusterObjectSetGeneratorMockRecorder {
	return m.recorder
}

// GenerateRevisionFromHelmRelease mocks base method.
func (m *MockOrbClusterObjectSetGenerator) GenerateRevisionFromHelmRelease(ctx context.Context, helmRelease *release.Release, ext *v1.ClusterExtension, objectLabels map[string]string) (*v1alpha1.ClusterObjectSetApplyConfiguration, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GenerateRevisionFromHelmRelease", ctx, helmRelease, ext, objectLabels)
	ret0, _ := ret[0].(*v1alpha1.ClusterObjectSetApplyConfiguration)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GenerateRevisionFromHelmRelease indicates an expected call of GenerateRevisionFromHelmRelease.
func (mr *MockOrbClusterObjectSetGeneratorMockRecorder) GenerateRevisionFromHelmRelease(ctx, helmRelease, ext, objectLabels any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GenerateRevisionFromHelmRelease", reflect.TypeOf((*MockOrbClusterObjectSetGenerator)(nil).GenerateRevisionFromHelmRelease), ctx, helmRelease, ext, objectLabels)
}
