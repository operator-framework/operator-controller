...
func ByChannelAndVersion(entity1 *input.Entity, entity2 *input.Entity) bool {
	e1 := variable_sources.NewBundleEntity(entity1)
	e2 := variable_sources.NewBundleEntity(entity2)
...
func packageOrder(e1, e2 *variable_sources.BundleEntity) int {
...
func channelOrder(e1, e2 *variable_sources.BundleEntity) int {
...
func versionOrder(e1, e2 *variable_sources.BundleEntity) int {
