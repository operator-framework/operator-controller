...
func ByChannelAndVersion(entity1 *input.Entity, entity2 *input.Entity) bool {
	e1 := NewBundleEntity(entity1)
	e2 := NewBundleEntity(entity2)
...
func packageOrder(e1, e2 *BundleEntity) int {
...
func channelOrder(e1, e2 *BundleEntity) int {
...
func versionOrder(e1, e2 *BundleEntity) int {
