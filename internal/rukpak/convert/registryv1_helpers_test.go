...
func assertFieldEqual(t *testing.T, obj client.Object, value interface{}, path string) bool { //nolint:unparam
	t.Helper()
...
func mustYAMLMarshal(v interface{}) []byte {
...
func genBundleFS(cfg genBundleConfig) fs.FS {
	...
	bundlePropertiesFile := map[string][]property.Property{
		"properties": bundleProperties(),
	}
	return fstest.MapFS{
		"manifests/configmap.yaml":  newFSFile(mustYAMLMarshal(configMap)),
		"manifests/csv.yaml":        newFSFile(mustYAMLMarshal(csv)),
		"manifests/crd.yaml":        newFSFile(mustYAMLMarshal(crd)),
		"metadata/annotations.yaml": newFSFile(mustYAMLMarshal(bundleAnnotations)),
		"metadata/properties.yaml":  newFSFile(mustYAMLMarshal(bundlePropertiesFile)),
	}
}
...
func bundleProperties() []property.Property {
	return []property.Property{
		{
			Type:  "property-type-from-file",
			Value: json.RawMessage(`"property-value-from-file"`),
		},
	}
}
...
func csvAnnotationsProperties() []property.Property {
	return []property.Property{{Type: "property-type-from-csv", Value: json.RawMessage(`"property-value-from-csv"`)}}
}
func csvAnnotations() map[string]string {
	return map[string]string{
		"csvAnnotation":  "csvAnnotationValue",
		"olm.properties": string(mustJSONMarshal(csvAnnotationsProperties())),
	}
}
func csvSpecAnnotations() map[string]string {
	return map[string]string{
		"csvSpecAnnotation": "csvSpecAnnotationValue",
	}
}
