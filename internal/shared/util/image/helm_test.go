...
func TestIsBundleSourceChart(t *testing.T) {
	...
	tt := []struct {
		...
		},
		{
			...
			want: want{
				value:  false,
				errStr: "reading testchart-0.1.0.tgz from fs: templates directory not found",
			},
		},
		{
			...
			want: want{
				value:  false,
				errStr: "reading testchart-0.1.0.tgz from fs: the Chart.yaml file was not found",
			},
		},
		{
			...
			want: want{
				value:  false,
				errStr: "reading testchart-0.1.0.tgz from fs: neither Chart.yaml nor templates directory were found",
			},
		},
	}
