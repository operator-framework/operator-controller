...
func TestMapAppCondtitionToStatus(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			app: &carvelv1alpha1.App{
				Status: carvelv1alpha1.AppStatus{
					GenericStatus: carvelv1alpha1.GenericStatus{
...

		{
			...
			app: &carvelv1alpha1.App{
				Status: carvelv1alpha1.AppStatus{
					GenericStatus: carvelv1alpha1.GenericStatus{
						Conditions: []carvelv1alpha1.Condition{{
							Type:   carvelv1alpha1.ReconcileSucceeded,
		...
		},
		{
			...
			app: &carvelv1alpha1.App{
				Status: carvelv1alpha1.AppStatus{
					GenericStatus: carvelv1alpha1.GenericStatus{
						Conditions: []carvelv1alpha1.Condition{{
							Type:    carvelv1alpha1.Reconciling,
							Status:  corev1.ConditionTrue,
							Message: "Reconciling",
						}},
		...
		},
		{
			...
			app: &carvelv1alpha1.App{
				Status: carvelv1alpha1.AppStatus{
					GenericStatus: carvelv1alpha1.GenericStatus{
						Conditions: []carvelv1alpha1.Condition{{
							Type:    carvelv1alpha1.ReconcileFailed,
							Status:  corev1.ConditionTrue,
		...
		},
		{
			...
			app: &carvelv1alpha1.App{
				Status: carvelv1alpha1.AppStatus{
					GenericStatus: carvelv1alpha1.GenericStatus{
						Conditions: []carvelv1alpha1.Condition{{
							Type:    carvelv1alpha1.DeleteFailed,
							Status:  corev1.ConditionTrue,
