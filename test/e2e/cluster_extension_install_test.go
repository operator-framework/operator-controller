...
func TestClusterExtensionInstallReResolvesWhenCatalogIsPatched(t *testing.T) {
	...
	updatedCatalogImage := fmt.Sprintf("%s/test-catalog:v2", os.Getenv("INCLUSTER_REGISTRY_HOST"))
...
func TestClusterExtensionInstallReResolvesWhenNewCatalog(t *testing.T) {
	...
	latestCatalogImage := fmt.Sprintf("%s/e2e/test-catalog:latest", os.Getenv("INCLUSTER_REGISTRY_HOST"))
