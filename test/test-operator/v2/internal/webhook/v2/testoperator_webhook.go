...
// +kubebuilder:webhook:path=/mutate-testolm-operator-framework-io-v2-testoperator,mutating=true,failurePolicy=fail,sideEffects=None,groups=testolm.operator-framework.io,resources=testoperators,verbs=create;update,versions=v2,name=mtestoperator-v2.kb.io,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-testolm-operator-framework-io-v2-testoperator,mutating=false,failurePolicy=fail,sideEffects=None,groups=testolm.operator-framework.io,resources=testoperators,verbs=create;update,versions=v2,name=vtestoperator-v2.kb.io,admissionReviewVersions=v1
...
func (v *TestOperatorCustomValidator) ValidateCreate(_ context.Context, obj runtime.Object) (admission.Warnings, error) {
	...
	return nil, apierrors.NewInvalid(
		schema.GroupKind{Group: testolmv2.GroupVersion.Group, Kind: testolmv2.TestOperatorKind},
		testOp.GetName(),
		allErrs,
	)
}
