...
.PHONY: deploy
deploy: manifests rukpak kustomize ## Deploy controller to the K8s cluster specified in ~/.kube/config.
...
run: kind-load install deploy ## Install and deploy all of the necessary resources for platform-operators
